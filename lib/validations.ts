...
export const UserSchema = z.object({
  ...
  image: z.string().url({ message: "Please provide a balid URL." }).optional(),
  location: z.string().optional(),
  portfolio: z
    .string()
    .url({ message: "Please provide a balid URL." })
    .optional(),
...
export const AnswerServerShema = AnswerSchema.extend({
  questionId: z.string().min(1, { message: "Question ID is required." }),
});
